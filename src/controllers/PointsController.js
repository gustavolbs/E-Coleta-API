...
var PointsController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        point = _a.sent();
                        if (!point) {
                            return [2 /*return*/, res.status(400).json({ error: "Point not found" })];
                        }
                        serializedPoint = __assign(__assign({}, point), { image_url: "http://192.168.25.8:3333/uploads/" + point.image });
    ...
    PointsController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, city, uf, items, trx, point, insertedIds, point_id_1, point_items, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, trx("point_items").insert(point_items)];
                    case 4:
                        _b.sent();
                        trx.commit();
